...
} else if ($_SERVER['SERVER_NAME'] == 'ig.simetri.in') {
	$config['base_url']		= 'http://ig.simetri.in';
	$config['base_path']	= '/vol/indocrm/gereja';
...
/* RECAPTCHA*/
$config['recaptcha_public_key'] = '6LdbdM8SAAAAAHfXJba-B94GPFow5yGtroUNpSOM';
$config['recaptcha_private_key'] = '6LdbdM8SAAAAAD1G1mp2axM9FQGW0JjmN9V8zU_A';


/* MOODLE */
$config['moodle_hash'] = ':Ju-t}VHhpQ1gNi4QTEXlHE{u.&CR<]';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
