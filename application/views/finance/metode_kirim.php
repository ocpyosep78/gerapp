<?php
	...
	$Permission = $this->M_Permission->GetCollection(array('GroupID' => $UserAdmin['group_id'], 'SingleData' => 'MetodePengiriman'));
?>

<?php $this->load->view('administrator/header', array('PageTitle' => 'Metode Pengiriman'));?>
<script type="text/javascript" src="<?php echo $this->config->item('base_url'); ?>/js/finance/metode_kirim.js"></script>
