<?php
	...
	$PermissionTagihan = $this->M_Permission->GetCollection(array('GroupID' => $UserAdmin['group_id'], 'SingleData' => 'Pembayaran'));
	$AccessGerejaID = $this->M_Permission->GetAccessGerejaID($UserAdmin);
?>

<?php $this->load->view('administrator/header', array('PageTitle' => 'Pembayaran'));?>
<script type="text/javascript" src="<?php echo $this->config->item('base_url'); ?>/js/finance/payment.js"></script>
